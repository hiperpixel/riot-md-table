<riot-table-pagination>
    <div class="rt-pagination">
        <riot-table-pagination-link each={p in self.pages}></riot-table-pagination-link>
    </div>
...
<riot-table-pagination-link>
    <span class="{1:rt-pagination-link opts.active:'active'}">
        {opts.pageNumber}
    </span>
    <script>
        var self = this;
